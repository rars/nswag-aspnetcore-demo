...
using NSwagDemoClient.Contracts;
...
namespace NSwagDemoClient.Clients
{
    ...
    public partial class ValuesClient 
    {
        ...
        /// <summary>Submit new value.</summary>
        ...
        /// <summary>Get specific value by id.</summary>
        ...
        /// <summary>Update the value with the specified id to the new value.</summary>
        ...
        /// <summary>Removes the value with the specified id.</summary>
